from classes_and_objects_exercise_revision.project.library import Library
from classes_and_objects_exercise_revision.project.registration import Registration
from classes_and_objects_exercise_revision.project.user import User
