...
class StudentTests(unittest.TestCase):
    ...
    def test_enroll_student_extends_courses_with_course_without_notes_when_invalid_add_course_notes_arguments_is_passed(
            self):
        course_name = "Python OOP"
        course_notes = ['note 1', 'note 2']
    ...
    def test_add_notes_updates_when_course_is_existing(self):
        course_name = "Python Advanced"
        courses = {course_name: ['note 1', 'note 2']}
