...
# print()
# print(controller.cars[0].type)
# print(controller.cars[0].model)
# print(controller.cars[0].is_taken)
# print()
# print(controller.cars[1].type)
# print(controller.cars[1].model)
# print(controller.cars[1].is_taken)
# print()
# print(controller.cars[2].type)
# print(controller.cars[2].model)
# print(controller.cars[2].is_taken)
# print()
# print(controller.cars[3].type)
# print(controller.cars[3].model)
# print(controller.cars[3].is_taken)
