...
class MovieTests(TestCase):
    ...
    def test_setter_raises_error_when_empty_string(self):
    ...
    def test_rt_returns_true_when_first_movie_has_greater_rating(self):
        ...
        expected_result = f'"{self.movie.name}" is better than "{another_movie.name}"'
